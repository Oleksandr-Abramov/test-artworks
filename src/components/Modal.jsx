...
export default function Modal({ isShowModal, closeModal, article }) {
  ...
  return (
    <Transition.Root show={isShowModal} as={Fragment}>
      <Dialog
        as="div"
      ...
      >
        ...
        <div className="fixed inset-0 z-10 w-screen overflow-y-auto">
          <div className="flex min-h-full m-auto lg:w-3/4 justify-center p-4 text-center items-center sm:p-0 w-full">
            <Transition.Child
              as={Fragment}
              enter="ease-out duration-300"
              ...
              <Dialog.Panel className="relative transform overflow-hidden bg-white text-left shadow-xl transition-all sm:my-8 ">
                <div className="bg-white px-4 pb-4 pt-5 sm:p-6 sm:pb-4">
                  <div className="">
                    <button
                      onClick={closeModal}
                      className=" absolute right-1 top-1 mx-auto flex h-12 w-12 flex-shrink-0 items-center justify-center sm:mx-0 sm:h-10 sm:w-10"
                    >
                      <XMarkIcon
